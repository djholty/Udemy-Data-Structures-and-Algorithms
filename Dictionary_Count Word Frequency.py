...
# The time complexity of this exercise is O(n), where n is the number of words in 
# the input list. The loop iterates through each word in the list once, and the 
# dictionary operations (get and update) take constant time, O(1), on average.

# Space complexity:

# The space complexity of this exercise is also O(n), where n is the number of 
# unique words in the input list. In the worst case, all words are unique, and 
# the word_count dictionary will have n entries.